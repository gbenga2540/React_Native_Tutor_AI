                ...
                <Home_Tab.Navigator
                        ...
                        <Home_Tab.Screen
                                ...
                                options={{
                                        ...
                                        tabBarIcon: ({ color }) => <HomeIcon width={26} height={26} color={color} />,
                                        tabBarLabel: 'Home',
                                }}
                        />
                        <Home_Tab.Screen
                                ...
                                options={{
                                        // eslint-disable-next-line react/no-unstable-nested-components
                                        tabBarIcon: ({ color }) => <LessonIcon width={26} height={26} color={color} />,
                                        tabBarLabel: 'Lesson',
                                }}
                        />
                        <Home_Tab.Screen
                                ...
                                options={{
                                        // eslint-disable-next-line react/no-unstable-nested-components
                                        tabBarIcon: ({ color }) => <HomeWorkIcon width={26} height={26} color={color} />,
                        ...
                        <Home_Tab.Screen
                                ...
                                options={{
                                        // eslint-disable-next-line react/no-unstable-nested-components
                                        tabBarIcon: ({ color }) => <ConversationIcon width={26} height={26} color={color} />,
                        ...
                        <Home_Tab.Screen
                                ...
                                options={{
                                        // eslint-disable-next-line react/no-unstable-nested-components
                                        tabBarIcon: ({ color }) => <ProfileIcon width={26} height={26} color={color} />,
                                        tabBarLabel: 'Profile',
                                }}
                        />
                </Home_Tab.Navigator>
...
//                 headerShown: false,
//                 tabBarActiveTintColor: Colors.Primary,
//                 tabBarInactiveTintColor: Colors.LightPurple2,
//                 tabBarStyle: styles.tabBar_main,
//                 tabBarLabelStyle: styles.tabBar_label,
//                 tabBarIconStyle: styles.tabBar_icon,
//                 tabBarShowLabel: true,
