        ...
        return (
                <View style={styles.acp_main}>
                        ...
                        <ScrollView style={{ flex: 1 }}>
                                <DisplayAvatar isMale={isMaleTutor} marginBottom={20} marginTop={30} marginHorizontal={22} />
                                <BasicButton2 buttonText="Customize" borderRadius={8} marginHorizontal={22} buttonHeight={56} backgroundColor={Colors.Primary} textColor={Colors.Primary} marginBottom={40} execFunc={nav_to_customize_voice} />
                        ...
                        <BasicButton buttonText="Save" borderRadius={8} marginHorizontal={22} buttonHeight={56} disabled={disableButton} marginTop={'auto'} marginBottom={Platform.OS === 'ios' ? 50 : 20} execFunc={save_character_customization} />
                </View>
        );
};
