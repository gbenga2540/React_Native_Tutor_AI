        ...
        return (
                <View style={styles.sub_main}>
                        ...
                        <ScrollView
                                ...
                                <View
                                        ...
                                        <View
                                                ...
                                                <View
                                                        ...
                                                        <ParentalControlIcon color={Colors.Green} width={22} height={22} />
                                                </View>
                                                <Text
                                                        style={{
                                                                fontFamily: fonts.Urbanist_700,
                                ...
                                <SecureTextEntry marginHorizontal={0.01} marginTop={10} inputValue={oldPassword} setInputValue={setOldPassword} placeHolderText="Enter your old password" />
                                <Text style={styles.payment_h_txt}>New Password</Text>
                                <SecureTextEntry marginHorizontal={0.01} marginTop={10} inputValue={newPassword} setInputValue={setNewPassword} placeHolderText="Enter a new password" />
                                <Text style={styles.payment_h_txt}>Confirm Password</Text>
                                <SecureTextEntry marginHorizontal={0.01} marginTop={10} inputValue={newCPassword} setInputValue={setNewCPassword} placeHolderText="Confirm your new password" />
                                <View style={{ marginBottom: 50 }}>{''}</View>
                        </ScrollView>
                        <BasicButton buttonText="Save" marginHorizontal={22} marginTop={'auto'} marginBottom={Platform.OS === 'ios' ? 50 : 20} execFunc={save_parental_control} />
                </View>
        );
};
