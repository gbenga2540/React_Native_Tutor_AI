        ...
        return (
                <View style={styles.pdp_main}>
                        ...
                        <ScrollView style={{ flex: 1 }}>
                                        ...
                                        <View style={styles.pdp_i_c_w}>
                                                <View style={styles.pdp_i_c}>
                                                        {displayPicture ? (
                                                                ...
                                                                <Image style={styles.pdp_i} source={require('../../Images/Extra/default_user_dp_light.jpg')} />
                                                        )}
                                                </View>
                                        </View>
                                ...
                                <RNDropDown dropdownData={NativeLanguagesChooser} value={language} setValue={setLanguage} height={56} width={Dimensions?.get('window')?.width - 44} disable={false} paddingHorizontal={7} marginRight={22} marginLeft={22} marginTop={10} marginBottom={30} />
                                <Text style={styles.pdp_txt}>Full Name</Text>
                                <BasicTextEntry placeHolderText="John Doe" inputValue={email} setInputValue={setEmail} marginTop={10} marginBottom={30} inputMode="text" />
                                <Text style={styles.pdp_txt}>Phone Number</Text>
                                <PhoneNumberInput setInputValue={setPhoneNo} setIsValid={setPhoneNoValid} defaultCode="US" marginTop={10} />
                                <Text style={styles.pdp_txt}>Email</Text>
                                <BasicTextEntry placeHolderText="johndoe@gmail.com" inputValue={email} setInputValue={setEmail} marginTop={10} marginBottom={30} inputMode="text" />
                                ...
                                <BasicButton buttonText="Edit Details" borderRadius={8} marginHorizontal={22} execFunc={edit_personal_details} buttonHeight={56} disabled={disableButton} marginTop={20} marginBottom={Platform.OS === 'ios' ? 50 : 20} />
                        </ScrollView>
                        <DatePicker
                                modal
                                mode="date"
