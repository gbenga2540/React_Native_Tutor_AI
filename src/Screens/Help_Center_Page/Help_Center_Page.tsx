        ...
        return (
                <View style={styles.hcp_main}>
                        ...
                        <ScrollView style={{ flex: 1, marginHorizontal: 24 }}>
                                <HeaderTab marginTop={20} marginBottom={20} header_1="FAQ" header_2="Contact Us" marginBetween={4} execFunc_Header_1={() => setCurrentTAB(1)} execFunc_Header_2={() => setCurrentTAB(2)} />
                                {currentTAB === 1 && (
                                        <View>
                                                <ScrollView
                                                        horizontal
                                                        ...
                                                        {faq_types?.map((item, index) => (
                                                                <TouchableOpacity
                                                                        style={{
                                                                                ...
                                                                                marginRight: 12,
                                                                                borderRadius: 20,
                                                                                borderColor: activeFAQ !== index ? Colors.Primary : undefined,

                                                                                backgroundColor: activeFAQ === index ? Colors.Primary : Colors?.White,
                                                                        }}
                                                                        ...
                                                                        <Text
                                                                                style={{
                                                                                        ...
                                                                                        fontSize: 15,
                                                                                        color: activeFAQ === index ? Colors.White : Colors.Primary,
                                                                                }}>
                                                                                {item}
                                                                        </Text>
                                                                </TouchableOpacity>
                                                ...
                                                <SearchBar inputValue={search} setInputValue={setSearch} placeHolderText="search" marginBottom={30} />
                                                {faqs?.map((item, index) => (
                                                        <FAQReader key={index} faq={item} />
                                                ))}
                                        </View>
                                )}
                                {currentTAB === 2 && contact_us?.map((item, index) => <ContactUsButton contact_us={item} key={index} />)}
                        </ScrollView>
                </View>
        );
};
