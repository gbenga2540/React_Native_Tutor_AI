        ...
        return (
                <View style={styles.home_main}>
                        ...
                        <View style={styles.h_header_cont}>
                                ...
                                <Image source={require('../../../test/Images/Test_DP.png')} style={styles.h_header_img} />
                        </View>
                        <ScrollView
                                style={{
                                        flex: 1,
                                ...
                                <View
                                        ...
                                        <View
                                                ...
                                                <TouchableOpacity
                                                        ...
                                                        <ProgressBar marginTop={15} progress={(55 / 70) * 100} height={4} backgroundColor={Colors.White} progressBackgroundColor={Colors.DeepBlue} marginHorizontal={17} />
                                                        <Text
                                                                style={{
                                                ...
                                                <TouchableOpacity
                                                        ...
                                                        <ProgressBar marginTop={15} progress={(70 / 100) * 100} height={4} backgroundColor={Colors.White} progressBackgroundColor={Colors.DeepBlue} marginHorizontal={17} />
                                                        <Text
                                                                style={{
                                                                        fontFamily: fonts.OpenSans_700,
                                                                        color: Colors.Primary,
                                        ...
                                        <View
                                                ...
                                                <TouchableOpacity
                                                        ...
                                                        <View
                                                                ...
                                                                <StatsReportIcon color={Colors.Primary} width={25} height={25} />
                                                        </View>
                                                        <View
                                                                style={{
                                                                        flexDirection: 'row',
                                        ...
                                        <View
                                                ...
                                                <View
                                                        ...
                                                        {test_assignments?.map((item, index) => (
                                                                <CheckMark key={index} day_num={item?.id} isCompleted={item?.completed} />
                                                        ))}
                                                </View>
                                        </View>
                                </View>
