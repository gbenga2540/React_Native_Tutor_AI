...
const ChangePasswordPage: FunctionComponent = () => {
        ...
        return (
                <View style={styles.cp_main}>
                        ...
                        <Text style={styles.cp_m_wt2}>Create a new, safe and secured password for your account</Text>
                        <SecureTextEntry placeHolderText="Enter your old password" inputValue={oldPassword} setInputValue={setOldPassword} marginBottom={15} />
                        <SecureTextEntry placeHolderText="Enter a new password" inputValue={newPassword} setInputValue={setNewPassword} marginBottom={15} />
                        <SecureTextEntry placeHolderText="Confirm your new password" inputValue={newCPassword} setInputValue={setNewCPassword} marginBottom={38} />
                        <BasicButton buttonText="Reset Password" borderRadius={8} marginHorizontal={22} execFunc={change_password_func} buttonHeight={56} disabled={disableButton} />
                        <Image
