        ...
        return (
                <LinearGradient
                        ...
                        <ScrollView style={{ flex: 1 }}>
                                ...
                                <Text style={styles.a_s_m_txt}>Learn English Language Effectively with our Ai Avatars.</Text>
                                <BasicButton buttonText="Create Account" marginHorizontal={22} marginTop={30} execFunc={nav_To_sign_up} />
                                <BasicButton buttonText="Sign In" marginHorizontal={22} marginTop={15} execFunc={nav_To_sign_in} textColor={Colors.Primary} backgroundColor={Colors.LightPurple} />
                        </ScrollView>
                </LinearGradient>
        );
};
