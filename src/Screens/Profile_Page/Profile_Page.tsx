...
import { profile_menu_1, profile_menu_2, profile_menu_3, profile_menu_4 } from '../../Data/Profile_Menu/Profile_Menu';
                        ...
                        <ScrollView style={{ flex: 1 }}>
                                <View style={styles.p_i_c_w}>
                                        <View style={styles.p_i_c}>
                                                {'' ? (
                                                        ...
                                                        <Image style={styles.p_i} source={require('../../Images/Extra/default_user_dp_light.jpg')} />
                                                )}
                                        </View>
                                </View>
                                <Text
                                ...
                                <View style={styles.p_menu_headers}>
                                        <View style={styles.p_menu_img}>
                                                <ProfileAccountIcon width={23} height={23} color={Colors.Primary} />
                                        </View>
                                        <Text style={styles.p_menu_txt}>Account</Text>
                                </View>
                                <MenuMaker borderRadius={15} backgroundColor={Colors.LightPurple2} menu={profile_menu_1} />
                                <View style={styles.p_menu_headers}>
                                        <View
                                                style={[
                                                        styles.p_menu_img,
                                                ...
                                                <ProfileSubscriptionIcon width={25} height={25} color={Colors.Primary} />
                                        </View>
                                        <Text style={styles.p_menu_txt}>Subscription</Text>
                                </View>
                                <MenuMaker borderRadius={15} backgroundColor={Colors.LightYellow3} menu={profile_menu_2} />
                                <View style={styles.p_menu_headers}>
                                        <View style={styles.p_menu_img}>
                                                <ProfileSecurityIcon width={30} height={30} color={Colors.Primary} />
                                        </View>
                                        <Text style={styles.p_menu_txt}>Security</Text>
                                </View>
                                <MenuMaker borderRadius={15} backgroundColor={Colors.LightPurple2} menu={profile_menu_3} />
                                <View style={styles.p_menu_headers}>
                                        <View
                                                style={[
                                                        styles.p_menu_img,
                                                ...
                                                <ProfileFilesFolderIcon width={28} height={28} color={Colors.Orange} />
                                        </View>
                                        <Text style={styles.p_menu_txt}>Contact & Information</Text>
                                </View>
                                <MenuMaker borderRadius={15} backgroundColor={Colors.LightOrange} menu={profile_menu_4} />
                                <View
                                        style={{
                                                marginBottom: 20,
                                        }}>
