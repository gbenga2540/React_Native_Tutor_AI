...
const CongratulationsPage: FunctionComponent = () => {
                ...
                execFunc: () => {
                        switch (route?.params?.nextPage) {
                                case 1:
                                        ...
                                        break;
                                case 2:
                                        navigation.push('HomeStack' as never, { screen: 'HomePage' } as never);
                                        break;
                                case 3:
                                        navigation.dispatch(
                                                CommonActions.reset({
        ...
        return (
                <View style={{ flex: 1 }}>
                        ...
                        <BasicButton buttonText="Continue" marginHorizontal={22} execFunc={proceed} marginBottom={Platform.OS === 'ios' ? 50 : 40} />
                </View>
        );
};
