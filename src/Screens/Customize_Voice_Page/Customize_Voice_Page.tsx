                                ...
                                <View
                                        ...
                                        <TouchableOpacity
                                                ...
                                                <View
                                                        ...
                                                        <Feather name="volume-2" color={Colors.DarkGrey} size={20} />
                                                </View>
                                                <Text
                                                        style={{
                                        ...
                                        <View
                                                ...
                                                <View
                                                        ...
                                                        <VoiceOverIcon color={Colors.Primary} width={25} height={25} />
                                                        <Text
                                                                style={{
                                                ...
                                                <View
                                                        ...
                                                        {(isMaleTutor ? Avatars?.Male : Avatars?.Female)?.map((item, index) => (
                                                                <TouchableOpacity
                                                                        style={{
                                                                                width: 100,
                                                                                height: 60,
                                                                                ...
                                                                                alignItems: 'center',
                                                                                borderWidth: index === activeVoice ? 1 : 0,
                                                                                borderColor: index === activeVoice ? Colors.Primary : undefined,
                                                                        }}
                                                                        activeOpacity={0.55}
