...
const ForgotPasswordPage: FunctionComponent = () => {
        ...
        return (
                <View style={styles.fp_main}>
                        ...
                        <Text style={styles.fp_m_wt2}>Enter Your Email to receive reset link.</Text>
                        <BasicTextEntry placeHolderText="Enter your email" inputValue={email} setInputValue={setEmail} marginTop={20} marginBottom={18} inputMode="email" />
                        <BasicButton buttonText="Send Mail" borderRadius={8} marginHorizontal={22} execFunc={send_mail} buttonHeight={56} disabled={disableButton} />
                        <Image
