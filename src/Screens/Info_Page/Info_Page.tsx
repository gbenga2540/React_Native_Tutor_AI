                ...
                <View style={{ flex: 1 }}>
                        ...
                        <View style={styles.info_main}>
                                ...
                                <LottieView
                                        ...
                                        speed={1.7}
                                />
                                {!hide_header && <Text style={[styles.i_m_err_txt, styles.i_m_err_txt_h]}>Successful!</Text>}
                                <Text style={styles.i_m_err_txt}>{route?.params?.success_mssg || ''}</Text>
                                <Text
                                        style={[
                                                styles.i_m_err_txt,
                                                {
                                ...
                                <View
                                        ...
                                        <BasicButton buttonText="PROCEED" buttonHeight={52} marginTop={0} marginBottom={0} execFunc={proceed} disabled={disableButton} />
                                </View>
                        </View>
                </View>
        );
