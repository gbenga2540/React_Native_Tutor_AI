        ...
        return (
                <View
                        ...
                        <Dropdown
                                ...
                                selectedTextStyle={[styles.selectedTextStyle, textColor ? { color: textColor } : {}]}
                                inputSearchStyle={[styles.inputSearchStyle]}
                                itemTextStyle={[styles.itemTextStyle, textColor ? { color: textColor } : {}]}
                                ...
                                labelField="label"
                                valueField="value"
                                placeholder={!isFocus ? unFocusPlaceHolder || 'Select Option' : focusPlaceHolder || '...'}
