...
const HeaderTab: FunctionComponent<HeaderTabProps> = ({ marginTop, marginBottom, marginHorizontal, marginBetween, execFunc_Header_1, execFunc_Header_2, header_1, header_2, show_numbers, number_1, number_2 }) => {
                ...
                <View
                        ...
                        <TouchableOpacity
                                ...
                                style={[
                                        styles.ht_m_btn,
                                        {
                                                borderBottomColor: isFirstTab ? Colors.Primary : Colors.DarkGrey,
                                ...
                                {show_numbers && <Text style={styles.ht_m_txt_2}>{`(${number_1 || 0})`}</Text>}
                        </TouchableOpacity>
                        <TouchableOpacity
                                activeOpacity={0.55}
                                onPress={exec_func_2}
                                ...
                                {show_numbers && <Text style={styles.ht_m_txt_2}>{`(${number_2 || 0})`}</Text>}
                        </TouchableOpacity>
                </View>
        );
};
