...
const MenuMaker: FunctionComponent<MenuMakerProps> = ({ menu, backgroundColor, textColor, lineColor, arrowColor, marginTop, marginBottom, marginHorizontal, borderRadius }) => {
                        ...
                        {menu?.length > 1 &&
                                menu?.map((item, index) => (
                                        <View key={item?.id}>
                                                ...
                                                {index !== menu?.length - 1 && <TextDivider singleLine marginHorizontal={15} lineColor={lineColor || 'rgba(255, 255, 255, 0.8)'} />}
                                        </View>
                                ))}
                </View>
        );
