...
const MultiRadioButton: FunctionComponent<MultiRadioButtonProps> = observer(({ option, marginTop, marginBottom, marginLeft, marginRight, answers, setAnswers, index, buttonHeight, borderRadius }) => {
