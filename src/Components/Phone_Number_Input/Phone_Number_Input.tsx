...
const PhoneNumberInput: FunctionComponent<PhoneNumberInputProps> = ({ defaultCode, setInputValue, setIsValid, marginBottom, marginHorizontal, marginTop, withDarkTheme, autoFocus, height }) => {
