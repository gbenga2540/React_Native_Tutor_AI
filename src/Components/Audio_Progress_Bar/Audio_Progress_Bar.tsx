...
const AudioProgressBar: FunctionComponent<AudioProgressBarProps> = ({ progress, speed, marginHorizontal, marginTop, marginBottom, height, borderRadius, progressWidth }) => {
        ...
        const progressDotStyle = useAnimatedStyle(() => {
                if (progressWidth) {
                        return {
                                transform: [
                                        {
                                                translateX: progressAnimation.value * ((progressWidth - 10) / 100),
                                        },
                                ],
                        };
                } else {
