...
import { InputModeOptions, KeyboardAvoidingView, Platform, StyleSheet, TextInput, TouchableOpacity } from 'react-native';
...
const SecureTextEntry: FunctionComponent<SecureTextEntryProps> = ({ inputValue, placeHolderText, setInputValue, marginTop, marginBottom, marginHorizontal, onFocus, onChange, inputMode, autoFocus, maxLength }) => {
                ...
                <KeyboardAvoidingView
                        ...
                        <TextInput
                                style={[
                                        styles.b_t_e_m_ti,
                                        {
                                                fontSize: Platform.OS === 'ios' ? 16 : hidePswd && inputValue?.length > 0 ? 20 : 16,
                                        },
                                ]}
