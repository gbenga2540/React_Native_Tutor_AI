...
const ProgressBar: FunctionComponent<ProgressBarProps> = ({ progress, speed, marginHorizontal, marginTop, marginBottom, height, borderRadius, backgroundColor, progressBackgroundColor }) => {
                        ...
                        <Animated.View
                                style={[
                                        StyleSheet.absoluteFill,
                                        {
                                                height: height || 10,
                                                borderRadius: borderRadius || 4,
                                                backgroundColor: progressBackgroundColor || Colors.Primary,
                                        },
                                        reanimatedStyle,
                                ]}
                        />
