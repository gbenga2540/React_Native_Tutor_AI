...
const BasicButton2: FunctionComponent<BasicButton2Props> = ({ buttonHeight, buttonText, marginTop, marginBottom, borderRadius, marginHorizontal, paddingHorizontal, execFunc, disabled, backgroundColor, textColor }) => {
        ...
        return (
                <TouchableOpacity
                        ...
                        activeOpacity={0.65}>
                        <Text style={[styles.b_b_m_txt, { color: textColor || Colors.Dark }]}>{buttonText}</Text>
                </TouchableOpacity>
        );
};
