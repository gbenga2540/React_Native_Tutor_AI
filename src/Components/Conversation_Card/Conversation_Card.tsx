...
const ConversationCard: FunctionComponent<ConversationCardProps> = ({ conversation, index, last_index }) => {
        return (
                <View
                        style={[
                        ...
                        <ArcInnerIcon style={{ position: 'absolute', right: 0 }} color={Colors.ArcInner_I} />
                        <ArcOuterIcon style={{ position: 'absolute', right: 0 }} color={Colors.ArcOuter_I} />
